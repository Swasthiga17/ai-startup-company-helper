  ...
  const navigate = useNavigate();
        ...
        >
          ...
          <div className="relative z-10 p-4 space-y-3.5 bg-black/20 backdrop-blur-xs border-t border-white/10">
            ...
            {/* Status card */}
            <div className="p-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15 flex items-center justify-between shadow-inner">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-base font-black text-emerald-400 tracking-wide">System Online</span>
                </div>
                <p className="text-xs text-pink-200 font-extrabold mt-1">AI Engine v2.0 Active</p>
              </div>
              <RobotMascot />
            </div>
          </div>
